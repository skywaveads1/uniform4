...
const siteArticles = [
  ...
  { title: 'نظرة عامة على أزياء طاقم الطائرة', path: '/blog/flight-crew/header-flight-crew-uniform', image: '/images/flight_crew/cabin_crew_uniforms.webp' },
  { title: 'مواد أزياء طاقم الطائرة', path: '/blog/flight-crew/flight-crew-uniform-materials', image: '/images/flight_crew/comfort_safety_airline_uniforms.webp' },
  { title: 'أزياء الطيران الذكية', path: '/blog/flight-crew/smart-airline-uniforms', image: '/images/flight_crew/air_crew_innovative_uniforms.webp' },
  ...
  { title: 'مستقبل موضة طاقم الطائرة', path: '/blog/aviation-uniforms/future-flight-crew-fashion', image: '/images/flight_crew/air_crew_innovative_uniforms.webp' },
  ...
  { title: 'أفضل موردي الزي المدرسي الموحد في الرياض', path: '/blog/academic-attire/academic-1', image: '/images/academic_attire/school_uniforms_riyadh.webp' },
  { title: 'كيفية اختيار أقمشة الزي المدرسي المناسبة لمناخ السعودية', path: '/blog/academic-attire/academic-2', image: '/images/academic_attire/school_uniform_fabrics.webp' },
